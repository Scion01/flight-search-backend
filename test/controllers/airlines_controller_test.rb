...
class AirlinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airline" do
    assert_difference('Airline.count') do
      post airlines_url, params: { airline: { logo_url: @airline.logo_url, name: @airline.name } }, as: :json
    end
  ...
  test "should update airline" do
    patch airline_url(@airline), params: { airline: { logo_url: @airline.logo_url, name: @airline.name } }, as: :json
    assert_response 200
  end
