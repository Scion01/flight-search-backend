...
class AirplanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create airplane" do
    assert_difference('Airplane.count') do
      post airplanes_url, params: { airplane: { model: @airplane.model, tail_number: @airplane.tail_number } }, as: :json
    end
  ...
  test "should update airplane" do
    patch airplane_url(@airplane), params: { airplane: { model: @airplane.model, tail_number: @airplane.tail_number } }, as: :json
    assert_response 200
  end
